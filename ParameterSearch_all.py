...
predict_path='dataset\\experiments\\'
files=glob.glob(predict_path+'*.txt')
with open('dataset\\results\\result_all_gauss.txt','w') as r:
    for data_path in files:
        ...
        print(max_d)
        print(r2_tmp)
        r.write(data_path+','+str(n_est)+','+str(lr)+','+str(max_d)+','+str(r2_tmp)+'\n')